...
namespace CRUD_Project
{
    public class Startup
    {
        ...
        private async Task CreateUserRoles(IServiceProvider serviceProvider) {
            ...
            roleCheck = await RoleManager.RoleExistsAsync("Default");
            if (!roleCheck) {
                //Create the roles and seed them to the database 
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<IdentityUser> userManager, IServiceProvider services)
        {
